...
public class SongSelect : MonoBehaviour
{
    ...
    private IEnumerator StartingSong(FileInfo chartFile)
    {
        ...
        Song song = null;
        SongLoader.Instance.Load(chartFile.FullName,
            delegate(Song _song) { song = _song; });
        fade.color = new Color(0,
            0,
            0,
            0);
        ...
        bool prepared = false;
        SongLoader.Instance.PrepareAudio(song,
            delegate { prepared = true; });
